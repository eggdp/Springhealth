package com.example.hello.handler.config;
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		*/
        ...
        http.csrf().disable()	// csrf 토큰을 비활성화
                ...
                .antMatchers("/","/login/**","/js/**","/css/**","/image/**", "/api/**").permitAll() // 해당 경로들은 접근을 허용
                .antMatchers("/best", "/test", "/see","/melon","/insert","/blog").permitAll()
